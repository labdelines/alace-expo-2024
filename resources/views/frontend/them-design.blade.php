...
<section style="background-color:rgb(45, 45, 45)">
    <div class="container header-body-section">
        <h3 data-aos="fade-up" data-aos-offset="200" data-aos-delay="50" data-aos-duration="1000">Them Design</h3>
    ...
    <div class="container annual-activity">
        ...
        <div class="show-activities">
            <div class="activity-rigth" data-aos="fade-up" data-aos-offset="200" data-aos-delay="50"
                ...
                <img src="{{ asset('frontend/assets/img/Theme Design/them1.png') }}" alt="">
            </div>
        </div>
        ...
        <div class="show-activities">
            <div class="activity-rigth" data-aos="fade-up" data-aos-offset="200" data-aos-delay="50"
                data-aos-duration="1000">
                <img src="{{ asset('frontend/assets/img/Theme Design/them2.png') }}" alt="">
            </div>
        </div>
        ...
        <div class="show-activities">
            <div class="activity-left" data-aos="fade-up" data-aos-offset="200" data-aos-delay="50"
                data-aos-duration="1000">
                <img src="{{ asset('frontend/assets/img/Theme Design/them3.png') }}" alt="">
            </div>
            <div class="activity-rigth" data-aos="fade-up" data-aos-offset="200" data-aos-delay="50"
                data-aos-duration="1000">
                <img src="{{ asset('frontend/assets/img/Theme Design/them3.1.png') }}" alt="">
            </div>
        </div>
