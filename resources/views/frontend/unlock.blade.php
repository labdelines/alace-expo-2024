...
<section style="background-color:rgb(45, 45, 45)">
    <div class="container header-body-section">
        <h3 data-aos="fade-up" data-aos-offset="200" data-aos-delay="50" data-aos-duration="1000">Unlock</h3>
    ...
    <div class="container annual-activity">
        <div class="show-activities1">
            <div class="activity-center" data-aos="fade-up" data-aos-offset="200" data-aos-delay="50"
                ...
                <img src="{{ asset('frontend/assets/img/Unlock/unlock2.png') }}" alt="">
            </div>
        </div>
    </div>
    <div class="container annual-activity">
        ...
        <div class="show-activities1">
            <div class="activity-center" data-aos="fade-up" data-aos-offset="200" data-aos-delay="50"
                data-aos-duration="1000">
                <img src="{{ asset('frontend/assets/img/Unlock/unlock3.png') }}" alt="">
            </div>
        </div>
    </div>
    <div class="container annual-activity">
        ...
        <div class="show-activities1">
            <div class="activity-center" data-aos="fade-up" data-aos-offset="200" data-aos-delay="50"
                data-aos-duration="1000">
                <img src="{{ asset('frontend/assets/img/Unlock/unlock4.png') }}" alt="">
            </div>
        </div>
    </div>
    <div class="container annual-activity">
        <div style="display: flex; align-items:center; justify-content:space-between" data-aos="fade-right"
            data-aos-offset="200" data-aos-delay="50" data-aos-duration="1000">
            <h2>The key to unlock</h2>
            <div class="horizontal-line"></div>
        </div><br />
        <div class="show-activities1">
            <div class="activity-center" data-aos="fade-up" data-aos-offset="200" data-aos-delay="50"
                data-aos-duration="1000">
                <img src="{{ asset('frontend/assets/img/Unlock/unlock5.png') }}" alt="">
            </div>
        </div>
    </div>
