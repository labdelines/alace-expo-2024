...
<section style="background-color:rgb(45, 45, 45)">
    <div class="container header-body-section">
        <h3 data-aos="fade-up" data-aos-offset="200" data-aos-delay="50" data-aos-duration="1000">Expo Fact Sheet</h3>
    ...
    <div class="container annual-activity">
        ...
        <div class="show-activities">
            <div class="activity-rigth" data-aos="fade-up" data-aos-offset="200" data-aos-delay="50"
                ...
                <img src="{{ asset('frontend/assets/img/Expo Fact Sheet/sheet1.png') }}" alt="">
                <img src="{{ asset('frontend/assets/img/Expo Fact Sheet/sheet11.png') }}" alt="">
            </div>
        </div>
        ...
        <div class="show-activities1">
            <div class="activity-center" data-aos="fade-up" data-aos-offset="200" data-aos-delay="50"
                data-aos-duration="1000">
                <img src="{{ asset('frontend/assets/img/Expo Fact Sheet/sheet2.png') }}" alt="">
            </div>
        </div>
        <div style="display: flex; align-items:center; justify-content:space-around" data-aos="fade-right"
            data-aos-offset="200" data-aos-delay="50" data-aos-duration="1000">
        ...
        <div class="show-activities1">
            <div class="activity-center" data-aos="fade-up" data-aos-offset="200" data-aos-delay="50"
                data-aos-duration="1000">
                <img src="{{ asset('frontend/assets/img/Expo Fact Sheet/sheet3.png') }}" alt="">
            </div>
        </div>
        <div style="display: flex; align-items:center; justify-content:space-around" data-aos="fade-right"
            data-aos-offset="200" data-aos-delay="50" data-aos-duration="1000">
        ...
        <div class="show-activities1">
            <div class="activity-center" data-aos="fade-up" data-aos-offset="200" data-aos-delay="50"
                data-aos-duration="1000">
                <img src="{{ asset('frontend/assets/img/Expo Fact Sheet/sheet4.png') }}" alt="">
            </div>
        </div>
        <div style="display: flex; align-items:center; justify-content:space-around" data-aos="fade-right"
            data-aos-offset="200" data-aos-delay="50" data-aos-duration="1000">
        ...
        <div class="show-activities1">
            <div class="activity-center" data-aos="fade-up" data-aos-offset="200" data-aos-delay="50"
                data-aos-duration="1000">
                <img src="{{ asset('frontend/assets/img/Expo Fact Sheet/sheet5.png') }}" alt="">
            </div>
        </div>
