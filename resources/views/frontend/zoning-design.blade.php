...
<section style="background-color:rgb(45, 45, 45)">
    <div class="container header-body-section">
        <h3 data-aos="fade-up" data-aos-offset="200" data-aos-delay="50" data-aos-duration="1000">Zoning Design</h3>
    ...
    <div class="container annual-activity">
        ...
        <div class="show-activities">
            <div class="activity-rigth" data-aos="fade-up" data-aos-offset="200" data-aos-delay="50"
                data-aos-duration="1000">
                <img src="{{ asset('frontend/assets/img/Zoning Design/zoom2.png') }}" alt="">
            </div>
        </div>
    </div>
    <div class="container annual-activity">
        ...
        <div class="show-activities">
            <div class="activity-rigth" data-aos="fade-up" data-aos-offset="200" data-aos-delay="50"
                data-aos-duration="1000">
                <img src="{{ asset('frontend/assets/img/Zoning Design/zoom3.png') }}" alt="">
            </div>
        </div>
    </div>
